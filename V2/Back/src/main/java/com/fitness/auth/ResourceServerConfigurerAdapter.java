...
public class ResourceServerConfigurerAdapter extends org.springframework.security.oauth2.config.annotation.web.configuration.ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
	    ...
	    http.authorizeRequests().antMatchers(HttpMethod.GET,"/api/paises/**","/api/provincias/**","/api/localidades/**","/images/**","/api/usuarios/uploads/img/**","/api/productosActivos/**","/api/productos/**","/api/productos/uploads/img/**","/src/main/resources/static/images/**" ).permitAll()
